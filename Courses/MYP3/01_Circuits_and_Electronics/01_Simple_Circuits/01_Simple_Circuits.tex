...
\begin{document}
    ...
    \subsubsection*{Directions}
    Create the following paper circuit. Your push button may look slightly different from the one in the diagram, so make the appropriate adjustments.
    ...
    \begin{tabularx}{\boxwidth}{| X | }
        ...
        \QuestionBox{In the spaces below, sketch the circuit diagrams for each of the two paper circuits you build.} \\\hline
    \end{tabularx}
