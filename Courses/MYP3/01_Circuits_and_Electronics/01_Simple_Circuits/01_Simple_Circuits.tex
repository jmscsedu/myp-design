...
\begin{document}
    ...
    \begin{tabularx}{\boxwidth}{| X | }
        ...
        \QuestionBox{In the spaces below, sketch the circuit diagrams for each of the two paper circuits you built.} \\\hline
    \end{tabularx}
    ...
    \begin{tabularx}{\boxwidth}{| X | }
        \hline
        \FormativeHeader \\\hline
        \QuestionBox{In the space below, sketch a paper circuit that will include (2) LEDs.} \\\hline
        \ \\[12cm]\hline
        \QuestionBox{Predict what will happen when your circuit is powered. Then, test your hypothesis by building the paper circuit.}
        \ \\\hline
        \ \\[4cm]\hline
        \QuestionBox{What actually happens when your circuit is powered? Why do you think this behaviour occurs?} \\\hline
        \ \\[4cm]\hline
    \end{tabularx}
    ...
    \begin{tabularx}{\boxwidth}{| X |}
        ...
        \ATLHeader{Communication Skills}\\\hline
        \ATLSkill{...make inferences and draw conclusions...}\\\hline
        \QuestionBox{Why do you think the ability to draw conclusions from incomplete information or knowledge is an important skill to develop? Are there any dangers in doing so?}\\\hline
        \ \\[3.5cm]\hline
        \ATLSkill{...use and interpret a range of discipline-specific terms and symbols...}\\\hline
        \QuestionBox{In what other contexts are special terms and symbols used? Consider examples from your daily life, such as your hobbies and other activities, and not just academics.}\\\hline
        \ \\[3.5cm]\hline
    \end{tabularx}
